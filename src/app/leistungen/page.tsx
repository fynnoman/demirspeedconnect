	...
	return (
		<div className="min-h-screen bg-white">
			...
			<section ref={heroRef} className="relative h-[70vh] bg-[#0F172A] flex items-center justify-center overflow-hidden">
				...
				<motion.div
					className="absolute left-0 top-0 w-4 h-full bg-[#1D4ED8]"
					initial={{ scaleY: 0 }}
					animate={{ scaleY: 1 }}
					transition={{ duration: 1 }}
				/>
				...
				<motion.div
					className="absolute right-0 top-0 w-1 h-full bg-[#1D4ED8]/40"
					initial={{ scaleY: 0 }}
					animate={{ scaleY: 1 }}
			...
			<section className="bg-[#1D4ED8] py-32">
				<div className="max-w-[1200px] mx-auto px-6 text-center">
					...
					>
						<Link
							href="/kontakt"
							className="px-10 py-4 bg-white text-[#1D4ED8] text-sm font-bold tracking-widest hover:bg-[#0F172A] hover:text-white transition-colors"
						>
							KONTAKT AUFNEHMEN
						</Link>
					</motion.div>
